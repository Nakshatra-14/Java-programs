...
public class Emp {
    ...
    public Emp(String empCode, long id, String fName, String lName, String gender, Date dob, Date dateOfJoining,
            String email, int phNo, String dept) {
    ...
    public static void main(String[] args) {
        Stream<String[]> stm = Emp.streamFromCSV();
        stm = stm.limit(50);
