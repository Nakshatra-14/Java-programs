...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        gbc = new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        billInfoPanel.add(new JLabel("Bill no.:"), gbc);
        gbc = new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, insets, 0, 0);
        billInfoPanel.add(lblBillNo, gbc);
        gbc = new GridBagConstraints(2, 0, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        billInfoPanel.add(new JLabel("Bill Date:"), gbc);
        gbc = new GridBagConstraints(3, 0, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, insets, 0, 0);
        billInfoPanel.add(txtFdBillDate, gbc);
        gbc = new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        billInfoPanel.add(new JLabel("Customer Name:"), gbc);
        gbc = new GridBagConstraints(1, 1, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, insets, 0, 0);
        billInfoPanel.add(txtFdcustName, gbc);
        gbc = new GridBagConstraints(2, 1, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        billInfoPanel.add(new JLabel("Phone:"), gbc);
        gbc = new GridBagConstraints(3, 1, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, insets, 0, 0);
        ...
        gbc = new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0);
        itemMgtPanel.add(new JLabel("Sl.No."), gbc);
        gbc = new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.NONE, insets, 0, 0);
        itemMgtPanel.add(new JLabel("Item Name"), gbc);
        gbc = new GridBagConstraints(2, 0, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        itemMgtPanel.add(new JLabel("Quantity"), gbc);
        gbc = new GridBagConstraints(3, 0, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        itemMgtPanel.add(new JLabel("Price"), gbc);
        gbc = new GridBagConstraints(4, 0, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        itemMgtPanel.add(new JLabel("Discount......"), gbc);
        gbc = new GridBagConstraints(0, 1, 5, 2, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets, 0, 0);
        itemMgtPanel.add(new JScrollPane(lst), gbc);
        gbc = new GridBagConstraints(5, 1, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets, 0, 0);
        itemMgtPanel.add(btnAdd, gbc);
        gbc = new GridBagConstraints(5, 2, 1, 1, 1.0, 1.0, GridBagConstraints.WEST, GridBagConstraints.BOTH, insets, 0, 0);
        ...
        gbc = new GridBagConstraints(3, 1, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        paymentDetailPanel.add(new JLabel("Grand Total:"), gbc);
        gbc = new GridBagConstraints(4, 1, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, insets, 0, 0);
        ...
        gbc = new GridBagConstraints(4, 2, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, insets, 0, 0);
        paymentDetailPanel.add(lblGrandDis, gbc);
        gbc = new GridBagConstraints(3, 3, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        paymentDetailPanel.add(new JLabel("Round Off(+/-):"), gbc);
        gbc = new GridBagConstraints(4, 3, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, insets, 0, 0);
        paymentDetailPanel.add(lblRoundOff, gbc);
        gbc = new GridBagConstraints(3, 4, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.NONE, insets, 0, 0);
        ...
        gbc = new GridBagConstraints(0, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, insets, 0, 0);
        mainPanel.add(billInfoPanel, gbc);
        gbc = new GridBagConstraints(0, 1, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.BOTH, insets, 0, 0);
        mainPanel.add(itemMgtPanel, gbc);
        gbc = new GridBagConstraints(0, 2, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.BOTH, insets, 0, 0);
        mainPanel.add(paymentDetailPanel, gbc);
        gbc = new GridBagConstraints(0, 3, 1, 1, 1.0, 1.0, GridBagConstraints.EAST, GridBagConstraints.BOTH, insets, 0, 0);
